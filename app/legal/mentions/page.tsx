      ...
      <header style={{ background: "var(--cream-50)", borderBottom: "1px solid var(--cream-200)", padding: "16px 24px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: 16, fontSize: 13 }}>
            <Link href="/legal/confidentialite" style={{ color: "var(--ink-400)", textDecoration: "none" }}>Confidentialité</Link>
            <Link href="/legal/cgv" style={{ color: "var(--ink-400)", textDecoration: "none" }}>CGV</Link>
