      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-20 flex-col justify-between border-r border-slate-200 bg-[#eef1f8] px-3 py-6 md:flex">
          <div className="space-y-4 fixed">
            <Link
              href="/dashboard"
              className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white sshadow-sm"
            >
          ...
          <div className="mx-auto max-w-7xl">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Gère tes dépenses ponctuelles et récurrentes en un seul endroit
                    </p>
                  </div>
                </div>
            ...
            <section className="mb-8">
              ...
              <p className="mt-2 text-lg text-slate-500">
                Ajoute, consulte et ajuste toutes tes sorties.
              </p>
            </section>
